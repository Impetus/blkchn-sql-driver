...
public abstract class AbstractSyntaxTreeVisitor extends AbstractParseTreeVisitor<LogicalPlan> implements
    ...
    @Override
    public LogicalPlan visitUnsupportedHiveNativeCommands(UnsupportedHiveNativeCommandsContext ctx) {
        logger.trace("In visitUnsupportedHiveNativeCommands " + ctx.getText());
        return visitChildren(ctx);
